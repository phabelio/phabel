...
class IssetExpressionFixer extends Plugin
{
    ...
    public static function staticExists($class, $property, $propertyOrConstant)
    {
        ...
        $classCaller = null !== ($phabel_878486457e5f8bb8 = \debug_backtrace(DEBUG_BACKTRACE_IGNORE_ARGS, 2)) && isset($phabel_878486457e5f8bb8[1]['class']) ? $phabel_878486457e5f8bb8[1]['class'] : '';
