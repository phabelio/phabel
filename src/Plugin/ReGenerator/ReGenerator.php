...
class ReGenerator implements \Iterator
{
    ...
    {
        if (!$this->started) {
            $phabel_88a9b3d1df35b4ba = $this->generator;
            $phabel_88a9b3d1df35b4ba($this->state, $this->variables, $this->yieldKey, $this->yieldValue, $this->sentValue, $this->sentException, $this->returnValue, $this->returned);
            $this->started = true;
        }
    }
    /**
    ...
    public function send($value)
    {
        ...
        if (!$this->returned) {
            ...
            try {
                $phabel_43f15bc1f37c1a9c = $this->generator;
                $phabel_43f15bc1f37c1a9c($this->state, $this->variables, $this->yieldKey, $this->yieldValue, $this->sentValue, $this->sentException, $this->returnValue, $this->returned);
            } catch (\Exception $e) {
                $this->returned = true;
                throw $e;
            } catch (\Error $e) {
    ...
    public function throw(\Throwable $throwable)
    {
        ...
        if (!$this->returned) {
            ...
            try {
                $phabel_59ce0d70da5debb7 = $this->generator;
                $phabel_59ce0d70da5debb7($this->state, $this->variables, $this->yieldKey, $this->yieldValue, $this->sentValue, $this->sentException, $this->returnValue, $this->returned);
            } catch (\Exception $e) {
                $this->returned = true;
                throw $e;
            } catch (\Error $e) {
