...
class ReGenerator implements \Iterator
{
    ...
    {
        if (!$this->started) {
            $phabel_3bcf0f6ffb6c8740 = $this->generator;
            $phabel_3bcf0f6ffb6c8740($this->state, $this->variables, $this->yieldKey, $this->yieldValue, $this->sentValue, $this->sentException, $this->returnValue, $this->returned);
            $this->started = true;
        }
    }
    /**
    ...
    public function send($value)
    {
        ...
        if (!$this->returned) {
            ...
            try {
                $phabel_a9c53315148cfe2a = $this->generator;
                $phabel_a9c53315148cfe2a($this->state, $this->variables, $this->yieldKey, $this->yieldValue, $this->sentValue, $this->sentException, $this->returnValue, $this->returned);
            } catch (\Exception $e) {
                $this->returned = true;
                throw $e;
            } catch (\Error $e) {
    ...
    public function throw(\Throwable $throwable)
    {
        ...
        if (!$this->returned) {
            ...
            try {
                $phabel_14adc989b92c2f69 = $this->generator;
                $phabel_14adc989b92c2f69($this->state, $this->variables, $this->yieldKey, $this->yieldValue, $this->sentValue, $this->sentException, $this->returnValue, $this->returned);
            } catch (\Exception $e) {
                $this->returned = true;
                throw $e;
            } catch (\Error $e) {
