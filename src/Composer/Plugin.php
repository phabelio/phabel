...
class Plugin implements PluginInterface, EventSubscriberInterface
{
    ...
    private function run(Event $event, $isUpdate)
    {
        ...
        if (!$this->transformer->transform(null !== ($phabel_afd2ff75822f773a = \json_decode(\file_get_contents('composer.lock'), true)) && isset($phabel_afd2ff75822f773a['packages']) ? $phabel_afd2ff75822f773a['packages'] : [])) {
