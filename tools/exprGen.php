...
PHP;
        ...
        foreach (\array_chunk($this->tests, 100) as $stmts) {
            ...
            foreach ($stmts as $stmt) {
                ...
                $sortedStmts[$method] = (new Method($method))->addStmt(new MethodCall(new Variable('this'), 'assertTrue', [new Arg(new Identical(new LNumber(0), new LNumber(0)))]))->addStmt(new Expression(new ArrowFunction(['expr' => $stmt])))->getNode();
            }
            \ksort($sortedStmts);
