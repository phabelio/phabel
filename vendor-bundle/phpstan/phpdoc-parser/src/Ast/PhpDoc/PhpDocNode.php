...
class PhpDocNode implements Node
{
    ...
    {
        return \array_column(\Phabel\Target\Php74\Polyfill::array_filter($this->getTagsByName($tagName), static function (PhpDocTagNode $tag) : bool {
    ...
    {
        return \array_column(\Phabel\Target\Php74\Polyfill::array_filter($this->getTagsByName('@deprecated'), static function (PhpDocTagNode $tag) : bool {
