...
final class CallableTask implements Task
{
    ...
    public function run(Environment $environment)
    {
        ...
        if (\is_array($this->callable) && (isset($this->callable[0]) ? $this->callable[0] : null) instanceof \__PHP_Incomplete_Class) {
        ...
        $phabel_d75a561f64a41f7d = $this->callable;
        return $phabel_d75a561f64a41f7d(...$this->args);
    }
}
