    ...
    public function receive() : Promise
    {
        ...
        return call(function () : \Generator {
            ...
            if ($data instanceof ExitResult) {
                $data = $data->getResult();
                throw new SynchronizationError(\sprintf('Thread unexpectedly exited with result of type: %s', \Phabel\Target\Php72\Polyfill::is_object($data) ? \get_class($data) : \gettype($data)));
            }
            return $data;
        });
    }
    ...
    public function send($data) : Promise
    {
        ...
        return call(function () use($data) : \Generator {
            try {
                ...
                throw new SynchronizationError(\sprintf('Thread unexpectedly exited with result of type: %s', \Phabel\Target\Php72\Polyfill::is_object($data) ? \get_class($data) : \gettype($data)), 0, $e);
            }
        });
    }
    /**
