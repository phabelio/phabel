...
final class Process implements Context
{
    ...
    public function __construct($script, string $cwd = null, array $env = [], string $binary = null)
    {
        ...
        if (\Phabel\Target\Php71\Polyfill::strpos(self::SCRIPT_PATH, "phar://") === 0) {
            if (self::$pharScriptPath) {
                ...
                $contents = \Phabel\Target\Php71\Polyfill::file_get_contents(self::SCRIPT_PATH);
    ...
    public function receive() : Promise
    {
        ...
        return call(function () : \Generator {
            ...
            if ($data instanceof ExitResult) {
                $data = $data->getResult();
                throw new SynchronizationError(\sprintf('Process unexpectedly exited with result of type: %s', \Phabel\Target\Php72\Polyfill::is_object($data) ? \get_class($data) : \gettype($data)));
            }
            return $data;
        });
    }
    ...
    public function send($data) : Promise
    {
        ...
        return call(function () use($data) : \Generator {
            try {
                ...
                throw new SynchronizationError(\sprintf('Process unexpectedly exited with result of type: %s', \Phabel\Target\Php72\Polyfill::is_object($data) ? \get_class($data) : \gettype($data)), 0, $e);
            }
        });
    }
    /**
