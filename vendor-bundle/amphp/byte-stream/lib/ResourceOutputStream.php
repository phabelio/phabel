...
final class ResourceOutputStream implements OutputStream
{
    ...
    public function __construct($stream, int $chunkSize = null)
    {
        ...
        if (\Phabel\Target\Php71\Polyfill::strpos($meta["mode"], "r") !== \false && \Phabel\Target\Php71\Polyfill::strpos($meta["mode"], "+") === \false) {
    ...
    public function close()
    {
        if (\is_resource($this->resource)) {
            ...
            if ($meta && \Phabel\Target\Php71\Polyfill::strpos($meta["mode"], "+") !== \false) {
