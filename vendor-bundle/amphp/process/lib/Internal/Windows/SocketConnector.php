...
final class SocketConnector
{
    ...
    public function onReadableHandshake($watcher, $socket)
    {
        ...
        $packet = \Phabel\Target\Php71\Polyfill::unpack('Csignal/Npid/Cstream_id/a*client_token', $data);
    ...
    public function onReadableHandshakeAck($watcher, $socket)
    {
        ...
        $packet = \Phabel\Target\Php71\Polyfill::unpack('Csignal/Cstatus', $data);
    ...
    public function onReadableChildPid($watcher, $socket, Handle $handle)
    {
        ...
        $packet = \Phabel\Target\Php71\Polyfill::unpack('Csignal/Npid', $data);
    ...
    public function onReadableExitCode($watcher, $socket, Handle $handle)
    {
        ...
        $packet = \Phabel\Target\Php71\Polyfill::unpack('Csignal/Ncode', $data);
