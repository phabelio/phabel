...
final class Runner implements ProcessRunner
{
    ...
    private function makeCommand(string $workingDirectory) : string
    {
        ...
        if (\strncmp($wrapperPath, "phar://", 7) === 0) {
            if (self::$pharWrapperPath === null) {
                self::$pharWrapperPath = \sys_get_temp_dir() . "amphp-process-wrapper-" . \hash('sha1', \Phabel\Target\Php71\Polyfill::file_get_contents(self::WRAPPER_EXE_PATH));
    ...
    {
        if (\Phabel\Target\Php71\Polyfill::strpos($command, "\x00") !== \false) {
