...
class Process implements \IteratorAggregate
{
    ...
    public function setEnv(array $env)
    {
        ...
        $env = \Phabel\Target\Php74\Polyfill::array_filter($env, function ($value) {
    ...
    private function escapeArgument($argument) : string
    {
        if (!\is_null($argument)) {
            if (!\is_string($argument)) {
                if (!(\is_string($argument) || \Phabel\Target\Php72\Polyfill::is_object($argument) && \method_exists($argument, '__toString') || (\is_bool($argument) || \is_numeric($argument)))) {
