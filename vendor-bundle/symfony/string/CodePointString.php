...
class CodePointString extends AbstractUnicodeString
{
    ...
    public function indexOf($needle, int $offset = 0)
    {
        ...
        $i = $this->ignoreCase ? \Phabel\Target\Php71\Polyfill::mb_stripos($this->string, $needle, $offset, 'UTF-8') : \Phabel\Target\Php71\Polyfill::mb_strpos($this->string, $needle, $offset, 'UTF-8');
    ...
    public function startsWith($prefix) : bool
    {
        ...
        if ($this->ignoreCase) {
            return 0 === \Phabel\Target\Php71\Polyfill::mb_stripos($this->string, $prefix, 0, 'UTF-8');
        }
