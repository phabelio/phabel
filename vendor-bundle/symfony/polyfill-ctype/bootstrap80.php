...
if (!function_exists('ctype_alnum')) {
    ...
    {
        if (!true) {
            throw new \TypeError(__METHOD__ . '(): Argument #1 ($text) must be of type mixed, ' . \Phabel\Plugin\TypeHintReplacer::getDebugType($text) . ' given, called in ' . \Phabel\Plugin\TypeHintReplacer::trace());
        }
