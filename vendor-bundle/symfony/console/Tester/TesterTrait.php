 ...
 */
namespace Phabel\Symfony\Component\Console\Tester;
...
use Phabel\Symfony\Component\Console\Output\StreamOutput;
/**
...
trait TesterTrait
{
    ...
    public function getDisplay($normalize = \false)
    {
        if (!\is_bool($normalize)) {
            if (!(\is_bool($normalize) || \is_numeric($normalize) || \is_string($normalize))) {
                throw new \TypeError(__METHOD__ . '(): Argument #1 ($normalize) must be of type bool, ' . \Phabel\Plugin\TypeHintReplacer::getDebugType($normalize) . ' given, called in ' . \Phabel\Plugin\TypeHintReplacer::trace());
            } else {
