...
class ConsoleOutput extends StreamOutput implements ConsoleOutputInterface
{
     ...
     */
    public function __construct($verbosity = self::VERBOSITY_NORMAL, bool $decorated = null, OutputFormatterInterface $formatter = null)
    {
        if (!\is_int($verbosity)) {
    ...
    private function isRunningOS400() : bool
    {
        ...
        return \false !== \Phabel\Target\Php71\Polyfill::stripos(\implode(';', $checks), 'OS400');
    }
    /**
     * @return resource
     */
