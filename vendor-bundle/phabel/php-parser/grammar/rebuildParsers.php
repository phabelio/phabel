...
/// Main script ///
///////////////////
$tokens = \Phabel\Target\Php71\Polyfill::file_get_contents($tokensFile);
foreach ($grammarFileToName as $grammarFile => $name) {
    echo "Building temporary {$name} grammar file.\n";
    $grammarCode = \Phabel\Target\Php71\Polyfill::file_get_contents($grammarFile);
    ...
    $resultCode = \Phabel\Target\Php71\Polyfill::file_get_contents($tmpResultFile);
