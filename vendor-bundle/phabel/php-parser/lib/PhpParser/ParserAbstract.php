...
abstract class ParserAbstract implements Parser
{
    ...
    */
    ...
    protected function getFloatCastKind(string $cast) : int
    {
        ...
        if (\Phabel\Target\Php71\Polyfill::strpos($cast, 'float') !== \false) {
            return Double::KIND_FLOAT;
        }
        if (\Phabel\Target\Php71\Polyfill::strpos($cast, 'real') !== \false) {
    ...
    protected function stripIndentation(string $string, int $indentLen, string $indentChar, bool $newlineAtStart, bool $newlineAtEnd, array $attributes)
    {
        ...
        return \preg_replace_callback($regex, function ($matches) use($indentLen, $indentChar, $attributes) {
            ...
            if (\false !== \Phabel\Target\Php71\Polyfill::strpos($prefix, $indentChar === " " ? "\t" : " ")) {
    ...
    {
        $kind = \Phabel\Target\Php71\Polyfill::strpos($startToken, "'") === \false ? String_::KIND_HEREDOC : String_::KIND_NOWDOC;
        ...
        $indentHasSpaces = \false !== \Phabel\Target\Php71\Polyfill::strpos($indentation, " ");
        $indentHasTabs = \false !== \Phabel\Target\Php71\Polyfill::strpos($indentation, "\t");
