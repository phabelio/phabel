...
namespace Phabel\Psr\Log\Test;

use Phabel\Psr\Log\LoggerInterface;
use Phabel\Psr\Log\LogLevel;
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('Phabel\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('Phabel\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('Phabel\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
