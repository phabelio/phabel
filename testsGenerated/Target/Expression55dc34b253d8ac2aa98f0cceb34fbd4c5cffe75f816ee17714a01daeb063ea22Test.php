 ...
 * @license MIT
 */
class Expression55dc34b253d8ac2aa98f0cceb34fbd4c5cffe75f816ee17714a01daeb063ea22Test extends TestCase
{
    ...
    function test0d52230b0c16f7926319552aca90b4293df4af0cbca387c33d5c150c6adbef66()
    {
        $this->assertTrue(true);
        fn() => (__DIR__)[$test];
    }
    ...
    function test16cb2e0ea3d87664e17e900abb93f656d825ec1ed15e144aa62911365609c052()
    {
        $this->assertTrue(true);
        fn() => ($test ** $test)[$test];
    }
    ...
    function test2619617d20095e7853121b40407b3240697313b794a0e17b7e60f411b6f82384()
    {
        $this->assertTrue(true);
        fn() => ($test & $test)[$test];
    }
    function test29fc1e82f5bac80e123bc4344752ffb768d03f54b43126705789d8c39aff35d0()
    {
        $this->assertTrue(true);
        fn() => ($test < $test)[$test];
    }
    function test2bc979e53281adbc3b9bf86462a2e6ca8b5d55b94fd4c457ba0689553403cad6()
    {
        $this->assertTrue(true);
        fn() => ($test > $test)[$test];
    }
    ...
    function test369d8b9eff8d843e0d2e1ca697b77de3ea860a47243bfc5ede83970de1219f6e()
    {
        $this->assertTrue(true);
        fn() => ($test <<= $test)[$test];
    }
    ...
    function test3c1d3ca32e0d70032f4fcc9dfc08b17f624b14e75003fe1acd63ec4652cd703d()
    {
        $this->assertTrue(true);
        fn() => ($test | $test)[$test];
    }
    ...
    function test4503c6cb281ac396cf969788ca532f3bf3d3ab4c27f6f3306d73726965688b09()
    {
        $this->assertTrue(true);
        fn() => $test[[]];
    }
    ...
    function test578532bd5834d5a68f654fc517959e80375775505d589353aff4dc1bb8bc73f4()
    {
        $this->assertTrue(true);
        fn() => ($test . $test)[$test];
    }
    ...
    function test5fc5eca6c02d50d340c12152f8e5f7391b064c674e0a6d1a23296bb34ee89b10()
    {
        $this->assertTrue(true);
        fn() => ($test != $test)[$test];
    }
    function test63463d015a5c4892e0a0014ea5d57c18dc2c8c64b1571e81f49319bf9d603f90()
    {
        $this->assertTrue(true);
        fn() => ($test ^ $test)[$test];
    }
    ...
    function test7787e556aa3b1db613aaffebe6a036393f65f8594aad8cfb73335bfc50dbd816()
    {
        $this->assertTrue(true);
        fn() => ($test - $test)[$test];
    }
    ...
    function testa56a6836910b0b37fb3519553821c4ee681fc9596b3ab7ffc46b0115490bfcd8()
    {
        $this->assertTrue(true);
        fn() => (__TRAIT__)[$test];
    }
    function testa6ef461b4a07d96f44d8689d2d5618fec9c19a967f68d365da8658e52f842bd4()
    {
        $this->assertTrue(true);
        fn() => ($test <=> $test)[$test];
    }
    function testa820fcc845a3992834a6bf2349e416affb09fb0b8f2a54a66daff584d3901f18()
    {
        $this->assertTrue(true);
        fn() => ("{$test}")[$test];
    }
    function testaad1a5e1d727263ed7a323e49484ab8c4a14ff514d96f967c0794886e8b95241()
    {
        $this->assertTrue(true);
        fn() => ($test || $test)[$test];
    }
    function testaebcc3a5030463442540019d66772e3e35498f994070e2e3ae1aef61686bdef3()
    {
        $this->assertTrue(true);
        fn() => (0.0)[$test];
    }
    ...
    function testb858ae5d4a907c3cfa688d031611dbd3a3f8f09a266a205ebb633d6306ead111()
    {
        $this->assertTrue(true);
        fn() => (__LINE__)[$test];
    }
    ...
    function testc7c140b29aa893f2b3babac536db697011f3374e4baf52d3374c8e2f584c319e()
    {
        $this->assertTrue(true);
        fn() => ((string) $test)[$test];
    }
    ...
    function testd758af9c0dc1fef3c1cd4d3d539bc14d96be05897953103d97b540861cb1e26b()
    {
        $this->assertTrue(true);
        fn() => $test[$test = $test];
    }
    ...
    function teste12340008487e2fc6efaaca610d3b25e91c4cb29af352d51e7070f681953de42()
    {
        $this->assertTrue(true);
    ...
    function teste6364a96398e000ebb81cfd16cdf572a289b2801b70dcbb01b2732e8fe0dc72b()
    {
        $this->assertTrue(true);
        fn() => ((double) $test)[$test];
    }
    ...
    function testf5ce1c2585c9457267f2c2340bd84dddfffc9361ba3acc34237d74748e266406()
    {
        $this->assertTrue(true);
    ...
    function testfe9626ff5d29db09d5a2601e0324cbcd61593473aa45cc9b755bb5b001e63a37()
    {
        $this->assertTrue(true);
        fn() => ($test == $test)[$test];
    }
