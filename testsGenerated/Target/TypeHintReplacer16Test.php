...
class TypeHintReplacer16Test extends TestCase
{
    ...
    {
        return [
[fn ($data): self|int => $data, 123, new class{}, '~.*Return value must be of type PhabelTest\\\\Target\\\\TypeHintReplacerTest\\|int, class@anonymous returned~'],
[function ($data): self|int { return $data; }, 123, new class{}, '~.*Return value must be of type PhabelTest\\\\Target\\\\TypeHintReplacerTest\\|int, class@anonymous returned~'],
[[$this, 'testRet76selfint'], 123, new class{}, '~.*Return value must be of type PhabelTest\\\\Target\\\\TypeHintReplacerTest\\|int, class@anonymous returned~'],
[[self::class, 'testRet76selfint'], 123, new class{}, '~.*Return value must be of type PhabelTest\\\\Target\\\\TypeHintReplacerTest\\|int, class@anonymous returned~'],
[fn ($data): self|int => $data, -1, new class{}, '~.*Return value must be of type PhabelTest\\\\Target\\\\TypeHintReplacerTest\\|int, class@anonymous returned~'],
[function ($data): self|int { return $data; }, -1, new class{}, '~.*Return value must be of type PhabelTest\\\\Target\\\\TypeHintReplacerTest\\|int, class@anonymous returned~'],
[[$this, 'testRet77selfint'], -1, new class{}, '~.*Return value must be of type PhabelTest\\\\Target\\\\TypeHintReplacerTest\\|int, class@anonymous returned~'],
[[self::class, 'testRet77selfint'], -1, new class{}, '~.*Return value must be of type PhabelTest\\\\Target\\\\TypeHintReplacerTest\\|int, class@anonymous returned~'],
...
;
    ...
    {
        return [
[fn (self|int $data): self|int => $data, 123, new class{}, '~.*Argument #1 \\(\\$data\\) must be of type PhabelTest\\\\Target\\\\TypeHintReplacerTest\\|int, class@anonymous given, .*~'],
[function (self|int $data): self|int { return $data; }, 123, new class{}, '~.*Argument #1 \\(\\$data\\) must be of type PhabelTest\\\\Target\\\\TypeHintReplacerTest\\|int, class@anonymous given, .*~'],
[[$this, 'test76selfint'], 123, new class{}, '~.*Argument #1 \\(\\$data\\) must be of type PhabelTest\\\\Target\\\\TypeHintReplacerTest\\|int, class@anonymous given, .*~'],
[[self::class, 'test76selfint'], 123, new class{}, '~.*Argument #1 \\(\\$data\\) must be of type PhabelTest\\\\Target\\\\TypeHintReplacerTest\\|int, class@anonymous given, .*~'],
[fn (self|int $data): self|int => $data, -1, new class{}, '~.*Argument #1 \\(\\$data\\) must be of type PhabelTest\\\\Target\\\\TypeHintReplacerTest\\|int, class@anonymous given, .*~'],
[function (self|int $data): self|int { return $data; }, -1, new class{}, '~.*Argument #1 \\(\\$data\\) must be of type PhabelTest\\\\Target\\\\TypeHintReplacerTest\\|int, class@anonymous given, .*~'],
[[$this, 'test77selfint'], -1, new class{}, '~.*Argument #1 \\(\\$data\\) must be of type PhabelTest\\\\Target\\\\TypeHintReplacerTest\\|int, class@anonymous given, .*~'],
[[self::class, 'test77selfint'], -1, new class{}, '~.*Argument #1 \\(\\$data\\) must be of type PhabelTest\\\\Target\\\\TypeHintReplacerTest\\|int, class@anonymous given, .*~'],
